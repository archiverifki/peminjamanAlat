...
if (isset($_SESSION['idPetugas'] )) {
    ...
    $_SESSION['keluar_dulu'] = "Anda harus Logout dulu !!";

    header("location: petugas");
}

elseif (isset($_SESSION['idMahasiswa']) ) {
    $_SESSION['keluar_dulu'] = "Anda harus Logout dulu !!";
 
    header("location: user");

}
elseif (isset($_SESSION['idPegawai']) ) {
    $_SESSION['keluar_dulu'] = "Anda harus Logout dulu !!";
...
<body class="hold-transition login-page" style="font-family: 'Quicksand', sans-serif;">
    <div class="login-box">
        ...
        <div class="login-box-body" style="border-radius: 10px;">
            ...
            <p style="text-align: center; font-size: 13px;">Hak Cipta &copy; <?= date('Y'); ?> .<?= $row1['nama_app']; ?> RC.</p>
